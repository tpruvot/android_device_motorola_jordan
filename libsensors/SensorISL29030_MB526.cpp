...
SensorISL29030P526::SensorISL29030P526()
...
int SensorISL29030P526::enable(int32_t handle, int en)
{
    int err = 0;
...
int SensorISL29030P526::readEvents(sensors_event_t* data, int count)
{
    if (count < 1) {
        return -EINVAL;
    }
...
void SensorISL29030P526::processEvent(int code, int value)
{
    switch (code) {
        case ABS_DISTANCE:
...
int SensorISL29030P526::isEnabled()
{
    int err = 0;
    char enabled = 0;
...
SensorISL29030L526::SensorISL29030L526()
...
int SensorISL29030L526::enable(int32_t handle, int en)
{
    int err = 0;
...
int SensorISL29030L526::isEnabled()
{
#ifdef DEFYPLUS
    int err = 0;
    char enabled = 0;
...
int SensorISL29030L526::readEvents(sensors_event_t* data, int count)
{
    if (count < 1) {
        return -EINVAL;
    }
...
void SensorISL29030L526::processEvent(int code, int value)
{
    switch (code) {
        case LED_MISC:
